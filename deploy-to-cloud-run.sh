...
echo "  --set-env-vars REACT_APP_KINDE_REDIRECT_URI=https://blabout.com/api/auth/kinde_callback,\\"
echo "  REACT_APP_KINDE_POST_LOGOUT_REDIRECT_URL=https://blabout.com,\\"
echo "  REACT_APP_KINDE_POST_LOGIN_REDIRECT_URL=https://blabout.com/dashboard,\\"
echo "  REACT_APP_API_URL=https://api.blabout.com"
